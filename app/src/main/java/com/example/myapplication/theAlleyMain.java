...
public class theAlleyMain extends AppCompatActivity implements OnMapReadyCallback {
    private GoogleMap map;
    private Button order;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_the_alley_main);
    ...
    public void onMapReady(GoogleMap googleMap) {
        map = googleMap;
        LatLng tancha = new LatLng(33.652273, -117.745575);
